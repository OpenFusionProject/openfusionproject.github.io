...
### The Remember Me button isnt working, leaving me frozen in the login screen or simply not saving my login information. Is there a fix?
...
### Can I use the same login information on every OpenFusion or OF adjacent server?
...
### Will my old account from FusionFall or FusionFall Retro work in OpenFusion?
...
### Is this a single player game? I can't seem to find anyone in-game.
...
### Are there any banks or places to store my items in?
...
### Will updates be made for the game, like adding content from FusionFall Retro or making brand new levels or nanos?
...
### Can I change my in-game character's appearance after making it in the tutorial? Such as changing their hair style, hair color, or skin tone?
...
### What is the difference between the Original and Academy servers?
...
### I can't get the Van Kleiss nano in the Academy server. Is there a way to get him?
...
### How can I give myself items in-game?
...
### I have an item code, how do I redeem it?
...
### How can I use the warp command?
...
### Where do I find the codes that I can use on the Academy server?
The FusionFall wiki maintains an [accurate list of code items](https://fusionfall.fandom.com/wiki/Codes).

### I can't equip items that I redeemed in the Academy server! They have a red border. Why is this?
...
### Can I make video content for or stream the game?
...
### Will there be new events? Like Valentines, Knishmas or Halloween?
...
### I can't progress in the Swampfire Nano mission, being stuck in a step. How can I fix this?
...
### The Academy server always crashes on me, or freezes, or is generally laggy. Can it be fixed?
...
### My camera spins around uncontrollably once I get ingame.
...
### I am stuck in a wall or area! How can I get unstuck?
...
### My UI is incredibly small when I go into Full Screen mode. Is there a way to fix this?
...
### Help! I accidentally deleted the public server from my launcher!
...
### I'm getting a LOGIN UNIMPLM or SHARD UNIMPLM error in the server log. How fix?
...
### Can I play the game on Android devices? Is it possible that a mobile port of the game will come out in the future?
